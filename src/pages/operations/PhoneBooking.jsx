...
function PhoneBooking() {
  ...
  const loadVehicleTypes = async () => {
    try {
      ...
      /*
        IMPORTANT:
        Use /vehicletypes instead of /vehicletypes/all.

        /vehicletypes is available for booking pages and
        returns ACTIVE vehicle types.
      */
      ...
      console.error(
        "Phone booking vehicle type error:",
        err
      );
      ...
      <main className="bk-page">
        <div className="bk-head">
          ...
          <p>
            ...
            who contacts MMC Taxi Operations
            by telephone.
          </p>
        </div>
        ...
        <div className="bk-grid">
          ...
          <aside className="bk-card">
            ...
            <div className="bk-info">
              ...
              <strong>
                Assign a matching available
                vehicle and driver from
                Booking Management.
              </strong>
            </div>
